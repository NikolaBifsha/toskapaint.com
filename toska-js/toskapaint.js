...
if (width > 1000 && window.scrollY <= 0) {
  document.getElementById("myLogoId").src = "/pics/Toska_White-min.png";
  window.addEventListener("scroll", () => {
    if (window.scrollY > 0) {
      document.getElementById("myLogoId").src = "/pics/Toska_Colour-min.png";
    } else {
      document.getElementById("myLogoId").src = "/pics/Toska_White-min.png";
    }
  });
